...
public class CadastrarServico extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButtonCadServico.setBackground(new java.awt.Color(0, 51, 255));
        jButtonCadServico.setFont(new java.awt.Font("Inter", 1, 14)); // NOI18N
        jButtonCadServico.setForeground(new java.awt.Color(255, 255, 255));
        jButtonCadServico.setText("Cadastrar");
        jButtonCadServico.addActionListener(this::jButtonCadServicoActionPerformed);
