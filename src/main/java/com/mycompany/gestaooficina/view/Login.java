...
public class Login extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        //VERIFICA SE O USUARIO E A SENHA ESTAO CORRETOS, CONSULTANDO O ARQUIVO DE USUARIOS PERSISTIDO
        if(com.mycompany.gestaooficina.control.GerenciamentoUsuarios.getInstance().autenticar(usuario, senha)){
            Home home = new Home();
