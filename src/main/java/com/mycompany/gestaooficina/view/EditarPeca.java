...
public class EditarPeca extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButtonEditarPeca.setBackground(new java.awt.Color(0, 51, 255));
        jButtonEditarPeca.setFont(new java.awt.Font("Inter", 1, 14)); // NOI18N
        jButtonEditarPeca.setForeground(new java.awt.Color(255, 255, 255));
        jButtonEditarPeca.setText("Editar");
        jButtonEditarPeca.addActionListener(this::jButtonEditarPecaActionPerformed);
    ...
    private void jButtonEditarPecaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonEditarPecaActionPerformed
        ...
        Editar edit = new Editar();
        edit.setVisible(true);
    }//GEN-LAST:event_jButtonEditarPecaActionPerformed
