...
public class Buscar extends javax.swing.JFrame {
    ...
    private void jButtonVerPecaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonVerPecaActionPerformed
        ...
        int cod = 0;
        try {
            cod = Integer.parseInt(textoCod);
            os = genPeca.buscarPeca(cod);
        } catch (NumberFormatException ex) {
            os = genPeca.buscarPeca(textoCod);
        ...
        if(os == null){
            ...
            JOptionPane.showMessageDialog(null, os.visualizarPeca());
        }
    ...
    private void jButtonVerServicoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonVerServicoActionPerformed
        ...
        try {
            cod = Integer.parseInt(textoCod);
            os = genServico.buscarServico(cod);
        } catch (NumberFormatException ex) {
            os = genServico.buscarServico(textoCod);
            System.out.println(os);
        }
    ...
    private void jButtonVerClientesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonVerClientesActionPerformed
        ...
        try {
            cod = Integer.parseInt(textoCod);
            os = genClient.buscarCliente(cod);
        } catch (NumberFormatException ex) {
            os = genClient.buscarCliente(textoCod);
            System.out.println(os);
        }
    ...
    private void jButtonVerFuncionarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonVerFuncionarioActionPerformed
        ...
        try {
            cod = Integer.parseInt(textoCod);
            os = genFunc.buscarFuncionario(cod);
        } catch (NumberFormatException ex) {
            os = genFunc.buscarFuncionario(textoCod);
            System.out.println(os);
        }
    ...
    private void jButtonVerVeiculoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonVerVeiculoActionPerformed
        ...
        try {
            cod = Integer.parseInt(textoCod);
            os = genVeic.buscarVeiculo(cod);
        } catch (NumberFormatException ex) {
            os = genVeic.buscarVeiculo(textoCod);
            System.out.println(os);
        }
