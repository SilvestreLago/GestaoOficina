...
public class EditarServico extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButtonEditarServico.setBackground(new java.awt.Color(0, 51, 255));
        jButtonEditarServico.setFont(new java.awt.Font("Inter", 1, 14)); // NOI18N
        jButtonEditarServico.setForeground(new java.awt.Color(255, 255, 255));
        jButtonEditarServico.setText("Editar");
        jButtonEditarServico.addActionListener(this::jButtonEditarServicoActionPerformed);
